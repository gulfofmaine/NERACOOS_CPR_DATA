...
list(
  ...
  # NOAA data
  tar_target(save_noaa_phytoplankton, 
             write_csv(noaa_phytoplankton_erddap, here::here("erddap_ready/noaa_gom_cpr_phytoplankton.csv"))),
  tar_target(save_noaa_zooplankton, 
             write_csv(noaa_zooplankton_erddap, here::here("erddap_ready/noaa_gom_cpr_zooplankton.csv"))),
  
  # MBA data
  tar_target(save_mba_phytoplankton, 
             write_csv(mba_phyto_erddap, here::here("erddap_ready/mba_gom_cpr_phytoplankton.csv"))),
  tar_target(save_mba_traverse, 
             write_csv(mba_traverse_erddap, here::here("erddap_ready/mba_gom_cpr_traverse.csv"))),
  tar_target(save_mba_eyecount, 
             write_csv(mba_eyecount_erddap, here::here("erddap_ready/mba_gom_cpr_eyecount.csv")))
