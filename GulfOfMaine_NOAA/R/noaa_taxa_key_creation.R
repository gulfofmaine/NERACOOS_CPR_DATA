...
noaa_gom_taxa_key <- list( 
  ...
  # This side is desired name             # This side is the input name
...
saveRDS(noaa_gom_taxa_key, file = here::here("GulfOfMaine_NOAA/taxa_resolving/noaa_gulfofmaine_taxa_key.rds"))

# Save the csv file for checking what happened
write_csv(key_table, here::here("GulfOfMaine_NOAA/taxa_resolving/noaa_gulfofmaine_taxa_key.csv"))
