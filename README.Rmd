...
There are two sequences of steps in the DAG above. These reflect the different cleanup paths for the data obtained from NOAA and the data obtained from the MBA. 
